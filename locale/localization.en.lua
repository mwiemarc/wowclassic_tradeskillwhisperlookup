...
if LOCALE == 'enUS' or LOCALE == 'enGB' or TSWL.L == nil then -- use english as fallback language
    ...
    L['CONFIG_DEFAULT_RESPONSE_FEATURED_HEADER'] = "Hey! This is a selection of my {{num_tradeskills}} Skills. If you have any questions don't be afraid to ask ;)"
    ...
    L['CONFIG_DEFAULT_RESPONSE_HINT_PAGING'] = 'Next page: {{request_cmd}} {{next_page}}'
    ...
    L['OPTIONS_TOOLTIP_FEATURED'] = 'Define (up to 16) Tradeskills/Items which will be retured instead of the default tradeskill list when just the whisper command is recieved without parameters.\n\n|cffffff00(Split multiple entrys by semicolon)|r'
