...
if LOCALE == 'enUS' or LOCALE == 'enGB' or TSWL.L == nil then -- use english as fallback language
    ...
    L['OPTIONS_TOOLTIP_FEATURED'] = 'Define Tradeskills/Items (up to 16) which will be retured instead of the default tradeskill list when just the whisper command is recieved without parameters.\n\n|cffffff00(Split multiple entrys by semicolon)|r'
