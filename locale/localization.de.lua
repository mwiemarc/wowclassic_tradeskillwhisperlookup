...
if LOCALE == 'deDE' then
    ...
    L['OPTIONS_TOOLTIP_AUTOCOMPLETE'] =
        'Verfügbar für |cff00ffffFertigkeiten|r/|cff00ffffItems|r und |cff00ffffWerteschlüssel|r\n\nMit |cff00ff00Shift+Tab|r bzw. |cff00ff00Strg+Tab|r können Sie zum nächsten oder letzten Vorschlag wechseln\nMit |cff00ff00Tab|r können Sie den Vorschlag akzeptieren\nMit |cff00ff00Alt|r können Sie die Autovervollständigung kurzzeitig aussetzten\n\n|cffffff00(Diese Funktion befindet sich noch in Entwicklung und könnte unerwartetes Verhalten zeigen)|r'
    ...
    L['OPTIONS_TOOLTIP_FEATURED'] = 'Definiere (bis zu 16) Fertigkeiten/Items welche Angezeigt werden wenn der Flüsterbefehl ohne weitere Parameter Empfangen wurde.\n\n|cffffff00(Trennen Sie mehrere Einträge durch ein Semikolon)|r'
